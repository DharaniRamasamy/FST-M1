...
@BeforeMethod
public void openPopUpURL() throws InterruptedException
{
		...
		Thread.sleep(3000);  
		wait.until(ExpectedConditions.elementToBeClickable(MobileBy.xpath("//android.view.View[4]/android.widget.Button")));
        driver.findElementByXPath("//android.view.View[4]/android.widget.Button").click();
        Thread.sleep(3000);
        wait.until(ExpectedConditions.elementToBeClickable(MobileBy.xpath("//android.widget.EditText[1]")));
		}
 
@Test(priority=1)
public void chromePopupsLoginSuccessful() throws InterruptedException {
    ...
    @Test(priority=2)
    public void chromePopupsLoginInvalidCredentials() throws InterruptedException {

        driver.findElementByXPath("//android.widget.EditText[1]").sendKeys("abcdef");
        Thread.sleep(3000);
        driver.findElementByXPath("//android.widget.EditText[2]").sendKeys("12345678");
        Thread.sleep(3000);
        driver.findElementByXPath("//android.widget.Button[@text='Log in']").click();
        Thread.sleep(3000);
        wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.xpath("//android.view.View/android.view.View[4]")));
